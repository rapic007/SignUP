...
//        hoursTextField.addTarget(self, action: #selector(textFieldChanged), for: .editingChanged)
    ...
    func setupCell() {
        ...
        hoursTextField.padding = UIEdgeInsets(top: 0, left: 16, bottom: 0, right: 16)
        hoursTextField.placeholder = "0        час"
        
        minutesTextField.padding = UIEdgeInsets(top: 0, left: 16, bottom: 0, right: 16)
        minutesTextField.placeholder = "0        мин"
        
        secondsTextField.padding = UIEdgeInsets(top: 0, left: 16, bottom: 0, right: 16)
        ...
        NSLayoutConstraint.activate([
            ...
            hoursTextField.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -270),
